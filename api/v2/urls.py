...
router.register(r'management_sources', views.ManagementSourceViewSet)
router.register(r'managed_items', views.ManagedItemViewSet)
router.register(r'managed_item_histories', views.ManagedItemHistoryViewSet)
