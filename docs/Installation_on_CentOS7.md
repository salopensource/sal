...
Unlike previous CentOS releases, 7 ships with Python 2.7.5 and thus a number of the initial steps from [the install Sal on CentOS6 guide](https://github.com/grahamgilbert/sal/blob/master/docs/Installation_on_CentOS6.md) can be skipped.
