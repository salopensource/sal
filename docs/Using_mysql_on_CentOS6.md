# Configuring Sal to use Mysql on CentOS
...
Now you can return to the rest of the [installation guide](https://github.com/salopensource/sal/blob/master/docs/Installation_on_CentOS6.md).
