...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'server_condition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('machine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Machine'])),
            ('condition_name', self.gf('django.db.models.fields.TextField')()),
            ('condtion_data', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'server', ['Condition'])


    def backwards(self, orm):
        # Deleting model 'Condition'
        db.delete_table(u'server_condition')
    ...
    models = {
        ...
        u'server.condition': {
            ...
            'condtion_data': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
