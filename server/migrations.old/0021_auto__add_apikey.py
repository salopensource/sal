...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApiKey'
        db.create_table(u'server_apikey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_key', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('private_key', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'server', ['ApiKey'])


    def backwards(self, orm):
        # Deleting model 'ApiKey'
        db.delete_table(u'server_apikey')
