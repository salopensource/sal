...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApiKey.read_only'
        db.add_column(u'server_apikey', 'read_only',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding unique constraint on 'ApiKey', fields ['public_key', 'private_key']
        db.create_unique(u'server_apikey', ['public_key', 'private_key'])


    def backwards(self, orm):
        # Removing unique constraint on 'ApiKey', fields ['public_key', 'private_key']
        db.delete_unique(u'server_apikey', ['public_key', 'private_key'])

        # Deleting field 'ApiKey.read_only'
        db.delete_column(u'server_apikey', 'read_only')
    ...
    models = {
        ...
        u'server.apikey': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('public_key', 'private_key'),)", 'object_name': 'ApiKey'},
            'has_been_seen': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'private_key': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'public_key': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
        ...
        u'server.historicalfact': {
            'Meta': {'ordering': "['fact_name', 'fact_recorded']", 'object_name': 'HistoricalFact'},
            'fact_data': ('django.db.models.fields.TextField', [], {}),
            'fact_name': ('django.db.models.fields.TextField', [], {}),
            'fact_recorded': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'machine': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['server.Machine']"})
        },
        u'server.machine': {
