...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'server_userprofile', 'level',
                      self.gf('django.db.models.fields.CharField')(default='SO', max_length=2),
                      keep_default=False)

        # Adding field 'Machine.last_checkin'
        db.add_column(u'server_machine', 'last_checkin',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'server_userprofile', 'level')

        # Deleting field 'Machine.last_checkin'
        db.delete_column(u'server_machine', 'last_checkin')
