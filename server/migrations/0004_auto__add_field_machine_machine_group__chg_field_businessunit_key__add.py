...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.machine_group'
        db.add_column(u'server_machine', 'machine_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['server.MachineGroup']),
                      keep_default=False)


        # Changing field 'BusinessUnit.key'
        db.alter_column(u'server_businessunit', 'key', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True, null=True))
        # Adding unique constraint on 'BusinessUnit', fields ['key']
        db.create_unique(u'server_businessunit', ['key'])


    def backwards(self, orm):
        # Removing unique constraint on 'BusinessUnit', fields ['key']
        db.delete_unique(u'server_businessunit', ['key'])

        # Deleting field 'Machine.machine_group'
        db.delete_column(u'server_machine', 'machine_group_id')


        # Changing field 'BusinessUnit.key'
        db.alter_column(u'server_businessunit', 'key', self.gf('django.db.models.fields.CharField')(default=1, max_length=256))
