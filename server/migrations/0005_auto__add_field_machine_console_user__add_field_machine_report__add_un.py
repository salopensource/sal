...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.console_user'
        db.add_column(u'server_machine', 'console_user',
                      self.gf('django.db.models.fields.CharField')(default='UNKNOWN', max_length=256),
                      keep_default=False)

        # Adding field 'Machine.report'
        db.add_column(u'server_machine', 'report',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding unique constraint on 'Machine', fields ['serial']
        db.create_unique(u'server_machine', ['serial'])


    def backwards(self, orm):
        # Removing unique constraint on 'Machine', fields ['serial']
        db.delete_unique(u'server_machine', ['serial'])

        # Deleting field 'Machine.console_user'
        db.delete_column(u'server_machine', 'console_user')

        # Deleting field 'Machine.report'
        db.delete_column(u'server_machine', 'report')
