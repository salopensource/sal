...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.errors'
        db.add_column(u'server_machine', 'errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Machine.warnings'
        db.add_column(u'server_machine', 'warnings',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Machine.activity'
        db.add_column(u'server_machine', 'activity',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.errors'
        db.delete_column(u'server_machine', 'errors')

        # Deleting field 'Machine.warnings'
        db.delete_column(u'server_machine', 'warnings')

        # Deleting field 'Machine.activity'
        db.delete_column(u'server_machine', 'activity')
