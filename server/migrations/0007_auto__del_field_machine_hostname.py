...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Machine.hostname'
        db.delete_column(u'server_machine', 'hostname')


    def backwards(self, orm):
        # Adding field 'Machine.hostname'
        db.add_column(u'server_machine', 'hostname',
                      self.gf('django.db.models.fields.CharField')(default='NULL', max_length=256),
                      keep_default=False)
