...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.memory_kb'
        db.add_column(u'server_machine', 'memory_kb',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.memory_kb'
        db.delete_column(u'server_machine', 'memory_kb')
    ...
    models = {
        ...
        u'server.machine': {
            ...
            'memory_kb': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
