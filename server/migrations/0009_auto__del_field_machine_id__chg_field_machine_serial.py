...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Machine.id'
        db.delete_column(u'server_machine', u'id')


        # Changing field 'Machine.serial'
        db.alter_column(u'server_machine', 'serial', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, primary_key=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Machine.id'
        raise RuntimeError("Cannot reverse this migration. 'Machine.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Machine.id'
        db.add_column(u'server_machine', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'Machine.serial'
        db.alter_column(u'server_machine', 'serial', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))
    ...
    models = {
        ...
        u'server.machine': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100', 'primary_key': 'True'}),
