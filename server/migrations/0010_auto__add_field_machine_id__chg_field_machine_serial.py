...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'server_machine', 'serial', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Machine.serial'
        db.alter_column(u'server_machine', 'serial', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, primary_key=True))
