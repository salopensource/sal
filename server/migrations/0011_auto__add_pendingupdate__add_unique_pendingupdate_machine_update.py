...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PendingUpdate'
        db.create_table(u'server_pendingupdate', (
        ...
        db.send_create_signal(u'server', ['PendingUpdate'])

        # Adding unique constraint on 'PendingUpdate', fields ['machine', 'update']
        db.create_unique(u'server_pendingupdate', ['machine_id', 'update'])


    def backwards(self, orm):
        # Removing unique constraint on 'PendingUpdate', fields ['machine', 'update']
        db.delete_unique(u'server_pendingupdate', ['machine_id', 'update'])

        # Deleting model 'PendingUpdate'
        db.delete_table(u'server_pendingupdate')
