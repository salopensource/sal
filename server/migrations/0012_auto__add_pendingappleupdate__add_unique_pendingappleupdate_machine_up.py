...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PendingAppleUpdate'
        db.create_table(u'server_pendingappleupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('machine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Machine'])),
            ('update', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('update_version', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal(u'server', ['PendingAppleUpdate'])

        # Adding unique constraint on 'PendingAppleUpdate', fields ['machine', 'update']
        db.create_unique(u'server_pendingappleupdate', ['machine_id', 'update'])


    def backwards(self, orm):
        # Removing unique constraint on 'PendingAppleUpdate', fields ['machine', 'update']
        db.delete_unique(u'server_pendingappleupdate', ['machine_id', 'update'])

        # Deleting model 'PendingAppleUpdate'
        db.delete_table(u'server_pendingappleupdate')
