...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WidgetToBusinnessUnit'
        db.create_table(u'server_widgettobusinnessunit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business_unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.BusinessUnit'])),
            ('widget', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Widget'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'server', ['WidgetToBusinnessUnit'])

        # Adding model 'TopWidgets'
        db.create_table(u'server_topwidgets', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('widget', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Widget'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'server', ['TopWidgets'])

        # Adding model 'Widget'
        db.create_table(u'server_widget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('widget_type', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('search_term', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'server', ['Widget'])


    def backwards(self, orm):
        # Deleting model 'WidgetToBusinnessUnit'
        db.delete_table(u'server_widgettobusinnessunit')

        # Deleting model 'TopWidgets'
        db.delete_table(u'server_topwidgets')

        # Deleting model 'Widget'
        db.delete_table(u'server_widget')
    ...
    models = {
        ...
        u'server.widget': {
            ...
            'search_term': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
