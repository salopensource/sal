...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.puppet_version'
        db.add_column(u'server_machine', 'puppet_version',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.puppet_version'
        db.delete_column(u'server_machine', 'puppet_version')
