...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Widget.ok_label'
        db.add_column(u'server_widget', 'ok_label',
        ...
        # Adding field 'Widget.warning_label'
        db.add_column(u'server_widget', 'warning_label',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Widget.alert_label'
        db.add_column(u'server_widget', 'alert_label',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Widget.ok_label'
        db.delete_column(u'server_widget', 'ok_label')

        # Deleting field 'Widget.ok_search'
        db.delete_column(u'server_widget', 'ok_search')

        # Deleting field 'Widget.warning_label'
        db.delete_column(u'server_widget', 'warning_label')

        # Deleting field 'Widget.warning_search'
        db.delete_column(u'server_widget', 'warning_search')

        # Deleting field 'Widget.alert_label'
        db.delete_column(u'server_widget', 'alert_label')
    ...
    models = {
        ...
        u'server.widget': {
            ...
            'alert_search': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'ok_search': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'warning_search': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
