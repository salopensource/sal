...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.last_puppet_run'
        db.add_column(u'server_machine', 'last_puppet_run',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Machine.puppet_errors'
        db.add_column(u'server_machine', 'puppet_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.last_puppet_run'
        db.delete_column(u'server_machine', 'last_puppet_run')

        # Deleting field 'Machine.puppet_errors'
        db.delete_column(u'server_machine', 'puppet_errors')
