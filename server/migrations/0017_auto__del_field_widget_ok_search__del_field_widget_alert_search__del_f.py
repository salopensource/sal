...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Widget.ok_search'
        db.delete_column(u'server_widget', 'ok_search')

        # Deleting field 'Widget.alert_search'
        db.delete_column(u'server_widget', 'alert_search')

        # Deleting field 'Widget.warning_search'
        db.delete_column(u'server_widget', 'warning_search')

        # Adding field 'Widget.ok_search_operator'
        db.add_column(u'server_widget', 'ok_search_operator',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Widget.ok_search_value'
        db.add_column(u'server_widget', 'ok_search_value',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Widget.warning_search_operator'
        db.add_column(u'server_widget', 'warning_search_operator',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Widget.warning_search_value'
        db.add_column(u'server_widget', 'warning_search_value',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Widget.alert_search_operator'
        db.add_column(u'server_widget', 'alert_search_operator',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Widget.alert_search_value'
        db.add_column(u'server_widget', 'alert_search_value',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Widget.ok_search'
        db.add_column(u'server_widget', 'ok_search',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Widget.alert_search'
        db.add_column(u'server_widget', 'alert_search',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Widget.warning_search'
        db.add_column(u'server_widget', 'warning_search',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Widget.ok_search_operator'
        db.delete_column(u'server_widget', 'ok_search_operator')

        # Deleting field 'Widget.ok_search_value'
        db.delete_column(u'server_widget', 'ok_search_value')

        # Deleting field 'Widget.warning_search_operator'
        db.delete_column(u'server_widget', 'warning_search_operator')

        # Deleting field 'Widget.warning_search_value'
        db.delete_column(u'server_widget', 'warning_search_value')

        # Deleting field 'Widget.alert_search_operator'
        db.delete_column(u'server_widget', 'alert_search_operator')

        # Deleting field 'Widget.alert_search_value'
        db.delete_column(u'server_widget', 'alert_search_value')
    ...
    models = {
        ...
        u'server.widget': {
            ...
            'alert_label': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'alert_search_operator': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'alert_search_value': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'}),
            'ok_label': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'ok_search_operator': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'ok_search_value': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'search_item': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'warning_label': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'warning_search_operator': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'warning_search_value': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
