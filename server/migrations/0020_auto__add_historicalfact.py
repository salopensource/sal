...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoricalFact'
        db.create_table(u'server_historicalfact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('machine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Machine'])),
            ('fact_name', self.gf('django.db.models.fields.TextField')()),
            ('fact_data', self.gf('django.db.models.fields.TextField')()),
            ('fact_recorded', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
        ))
        db.send_create_signal(u'server', ['HistoricalFact'])


    def backwards(self, orm):
        # Deleting model 'HistoricalFact'
        db.delete_table(u'server_historicalfact')
