...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApiKey.has_been_seen'
        db.add_column(u'server_apikey', 'has_been_seen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApiKey.has_been_seen'
        db.delete_column(u'server_apikey', 'has_been_seen')
    ...
    models = {
        ...
        u'server.apikey': {
            'Meta': {'ordering': "['name']", 'object_name': 'ApiKey'},
