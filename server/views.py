...
def bu_dashboard(request, bu_id):
    ...
    if user_level == 'GA' or user_level == 'RW':
        is_editor = True
    c = {'user': request.user, 'machine_groups': machine_groups, 'is_editor': is_editor, 'business_unit': business_unit, }
...
def group_dashboard(request, group_id):
    ...
    c = {'user': request.user, 'machine_group': machine_group, 'user_level': user_level, 'machine_data':machine_data, 'is_editor': is_editor, 'business_unit': business_unit}
...
def checkin(request):
    ...
    if machine:
        ...
        if 'ManifestName' in report_data:
            ...
            machine_group = MachineGroup.objects.filter(business_unit=business_unit, manifest=manifest)
